...
- 2026-02-22 02:02 : Daily sync ran. Thangs analytics scraped successfully (views 9.2K, likes 159, downloads 259, total plan purchases 49, unpaid earnings A$1,128.57). Cults3D `/en/sales` redirected to log-in; existing Cults values retained.
- 2026-02-24 02:01 : Daily sync ran. Thangs `/designer/echoesofidols/analytics` was not accessible headlessly (redirected to public portfolio; analytics/member-revenue panels unavailable). Public profile metrics observed: model views 8.7K, downloads 243, likes 152. Cults3D `/en/sales` redirected to log-in; existing Cults values retained.
